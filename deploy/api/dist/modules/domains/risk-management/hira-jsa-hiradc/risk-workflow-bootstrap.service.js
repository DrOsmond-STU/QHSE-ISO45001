...
exports.RiskWorkflowBootstrapService = void 0;
...
// ini).
let RiskWorkflowBootstrapService = class RiskWorkflowBootstrapService {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    async ensureNumberingConfig(moduleCode, pattern, prefix) {
    ...
    async findRoleOrThrow(tx, roleCode) {
        ...
        if (!role) {
            throw new common_1.NotFoundException(`Role sistem "${roleCode}" tidak ditemukan — RBAC baseline (seed-rbac-baseline.ts) wajib dijalankan sebelum modul Risk Management bisa membuat workflow_definitions default.`);
        }
        return role;
    }
    /**
     ...
     */
    async ensureHiraWorkflowDefinition(tx) {
        const tenantId = (0, risk_matrix_context_1.requireTenantId)();
     ...
     */
    async ensureJsaWorkflowDefinition(tx) {
        const tenantId = (0, risk_matrix_context_1.requireTenantId)();
        const existing = await tx.workflowDefinition.findFirst({
     ...
     */
    async ensureHiradcWorkflowDefinition(tx) {
        const tenantId = (0, risk_matrix_context_1.requireTenantId)();
        const existing = await tx.workflowDefinition.findFirst({
...
exports.RiskWorkflowBootstrapService = RiskWorkflowBootstrapService;
exports.RiskWorkflowBootstrapService = RiskWorkflowBootstrapService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], RiskWorkflowBootstrapService);
//# sourceMappingURL=risk-workflow-bootstrap.service.js.map