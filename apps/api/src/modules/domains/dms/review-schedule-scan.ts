 ...
 */
export function findReviewsDueForReminder(candidates: ReviewScheduleCandidate[], now: Date): ReviewScheduleCandidate[] {
  return candidates.filter((c) => {
    if (c.actualReviewDate !== null) return false;
 ...
 */
export function findOverdueReviewSchedules(candidates: ReviewScheduleCandidate[], now: Date): ReviewScheduleCandidate[] {
  return candidates.filter((c) => {
    if (c.actualReviewDate !== null) return false;
