...
export const DELEGATION_SCAN_QUEUE = "delegation-scan";
export const DELEGATION_SCAN_JOB_NAME = "scan";
...
export const DELEGATION_SCAN_CRON = process.env.DELEGATION_SCAN_CRON ?? "45 0 * * *";
