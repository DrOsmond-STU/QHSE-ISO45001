...
export const USAGE_COUNTER_SCAN_QUEUE = "usage-counter-scan";
export const USAGE_COUNTER_SCAN_JOB_NAME = "scan";
...
export const USAGE_COUNTER_SCAN_CRON = process.env.USAGE_COUNTER_SCAN_CRON ?? "0 1 * * *";
