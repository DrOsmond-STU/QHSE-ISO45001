...
/** roleCode ROLE_CODES key (mis. "SUPERVISOR"/"HSE_MANAGER") — scopeType
 * TENANT/scopeId null (pola sama modul lain) krn ApproverResolutionService.resolveApprovers()
 * ROLE_IN_SCOPE MASIH tenant-wide saja. */
...
/** company_id/site_id pada work_permits PUNYA FK sungguhan — test yang
