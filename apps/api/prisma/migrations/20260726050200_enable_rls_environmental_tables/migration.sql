...
GRANT SELECT, INSERT, UPDATE, DELETE ON "environmental_aspects_impacts" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "environmental_monitoring_records"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "environmental_monitoring_records" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "waste_manifest_records"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "waste_manifest_records" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "waste_generation_log"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "waste_generation_log" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "proper_self_assessment"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "proper_self_assessment" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "proper_self_assessment_criteria_scores"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "proper_self_assessment_criteria_scores" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "environmental_permits"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "environmental_permits" TO qhse_app;
