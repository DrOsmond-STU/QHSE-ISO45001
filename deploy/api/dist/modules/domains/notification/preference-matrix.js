...
exports.buildPreferenceMatrix = buildPreferenceMatrix;
...
const EDITABLE_CHANNELS = ["EMAIL", "WHATSAPP", "TELEGRAM"];
/**
 ...
 */
function buildPreferenceMatrix(existingRows) {
    const cells = [];
    for (const category of event_category_1.EVENT_CATEGORIES) {
        cells.push({
...
//# sourceMappingURL=preference-matrix.js.map