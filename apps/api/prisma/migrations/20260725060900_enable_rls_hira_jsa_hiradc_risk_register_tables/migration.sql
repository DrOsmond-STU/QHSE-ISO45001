...
GRANT SELECT, INSERT, UPDATE, DELETE ON "hira_assessments" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "hira_team_members"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "hira_team_members" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "hira_hazard_lines"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "hira_hazard_lines" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "jsa_records"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "jsa_records" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "jsa_job_steps"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "jsa_job_steps" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "jsa_step_hazards"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "jsa_step_hazards" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "jsa_crew_acknowledgements"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "jsa_crew_acknowledgements" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "hiradc_records"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "hiradc_records" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "hiradc_lines"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "hiradc_lines" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "risk_register"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "risk_register" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "risk_treatment_plans"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "risk_treatment_plans" TO qhse_app;
