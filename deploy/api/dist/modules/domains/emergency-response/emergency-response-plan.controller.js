...
exports.EmergencyResponsePlanController = void 0;
...
let EmergencyResponsePlanController = class EmergencyResponsePlanController {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
...
exports.EmergencyResponsePlanController = EmergencyResponsePlanController;
__decorate([
    (0, require_permission_decorator_1.RequirePermission)("emergency_response.plan.read"),
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [list_query_dto_1.ListQueryDto]),
    __metadata("design:returntype", Promise)
], EmergencyResponsePlanController.prototype, "list", null);
__decorate([
    (0, require_permission_decorator_1.RequirePermission)("emergency_response.plan.read"),
    (0, common_1.Get)(":id"),
    ...
    __metadata("design:returntype", Promise)
], EmergencyResponsePlanController.prototype, "getById", null);
exports.EmergencyResponsePlanController = EmergencyResponsePlanController = __decorate([
    (0, common_1.Controller)("emergency-response-plans"),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], EmergencyResponsePlanController);
//# sourceMappingURL=emergency-response-plan.controller.js.map