...
GRANT SELECT, INSERT, UPDATE, DELETE ON "tenants" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "organization_charts"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "organization_charts" TO qhse_app;
