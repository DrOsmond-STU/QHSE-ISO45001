...
exports.validateComplianceEvaluationStatusTransition = validateComplianceEvaluationStatusTransition;
exports.assertCanCloseEvaluation = assertCanCloseEvaluation;
exports.computeNextObligationDueDate = computeNextObligationDueDate;
...
function validateComplianceEvaluationStatusTransition(from, to) {
...
function assertCanCloseEvaluation(complianceStatus, linkedCapaId) {
    const requiresCapa = complianceStatus === "NON_COMPLIANT" || complianceStatus === "PARTIALLY_COMPLIANT";
    if (requiresCapa && linkedCapaId === null) {
        throw new Error(`compliance_evaluations dengan compliance_status=${complianceStatus} wajib memiliki linked_capa_id sebelum status CLOSED (BR-03).`);
    }
}
...
function computeNextObligationDueDate(closedAt, frequency) {
...
//# sourceMappingURL=compliance-evaluation-lifecycle.js.map