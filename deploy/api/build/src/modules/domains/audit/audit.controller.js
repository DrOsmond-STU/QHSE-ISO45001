...
__decorate([
    (0, require_permission_decorator_1.RequirePermission)("audit.audit.read"),
    (0, common_1.Get)(),
...
__decorate([
    (0, require_permission_decorator_1.RequirePermission)("audit.finding.read"),
    (0, common_1.Get)(":id/findings"),
    __param(0, (0, common_1.Param)("id")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AuditController.prototype, "findings", null);
