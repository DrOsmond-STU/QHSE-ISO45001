...
GRANT SELECT, INSERT, UPDATE, DELETE ON "inspection_types" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "inspection_checklist_templates"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "inspection_checklist_templates" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "inspection_checklist_template_items"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "inspection_checklist_template_items" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "inspection_schedules"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "inspection_schedules" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "inspection_records"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "inspection_records" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "inspection_record_items"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "inspection_record_items" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "inspection_findings"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "inspection_findings" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "inspection_scores"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "inspection_scores" TO qhse_app;
