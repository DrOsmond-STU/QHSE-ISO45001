...
exports.validateEmergencyActivationStatusTransition = validateEmergencyActivationStatusTransition;
exports.computeMissingPersonCount = computeMissingPersonCount;
...
function validateEmergencyActivationStatusTransition(from, to) {
...
function computeMissingPersonCount(totalExpectedHeadcount, totalCheckedInCount) {
    if (totalExpectedHeadcount === null)
        return null;
    return Math.max(0, totalExpectedHeadcount - totalCheckedInCount);
}
//# sourceMappingURL=emergency-activation-rules.js.map