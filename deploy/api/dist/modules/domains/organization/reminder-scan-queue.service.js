...
var ReminderScanQueueService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReminderScanQueueService = void 0;
const common_1 = require("@nestjs/common");
const bullmq_1 = require("bullmq");
const ioredis_1 = __importDefault(require("ioredis"));
const redis_enabled_helper_1 = require("../../../platform/scheduling/redis-enabled.helper");
const reminder_scan_constants_1 = require("./reminder-scan.constants");
...
let ReminderScanQueueService = ReminderScanQueueService_1 = class ReminderScanQueueService {
    logger = new common_1.Logger(ReminderScanQueueService_1.name);
    connection;
    queue;
    constructor() {
        ...
        this.queue = new bullmq_1.Queue(reminder_scan_constants_1.REMINDER_SCAN_QUEUE, { connection: this.connection });
    }
    async onApplicationBootstrap() {
        if (!this.queue)
            return;
        await this.queue.add(reminder_scan_constants_1.REMINDER_SCAN_JOB_NAME, {}, {
            repeat: { pattern: reminder_scan_constants_1.REMINDER_SCAN_CRON },
            jobId: reminder_scan_constants_1.REMINDER_SCAN_JOB_NAME,
            removeOnComplete: true,
            removeOnFail: 50,
        });
        this.logger.log(`Repeatable job "${reminder_scan_constants_1.REMINDER_SCAN_QUEUE}" terdaftar (cron: ${reminder_scan_constants_1.REMINDER_SCAN_CRON}).`);
    }
...
exports.ReminderScanQueueService = ReminderScanQueueService;
exports.ReminderScanQueueService = ReminderScanQueueService = ReminderScanQueueService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [])
], ReminderScanQueueService);
//# sourceMappingURL=reminder-scan-queue.service.js.map