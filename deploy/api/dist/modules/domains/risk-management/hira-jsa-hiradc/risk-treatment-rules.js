...
exports.assertAcceptRequiresTopManagementApproval = assertAcceptRequiresTopManagementApproval;
/**
 ...
 */
function assertAcceptRequiresTopManagementApproval(treatmentStrategy, sourceRequiresEscalation, topManagementApprovedBy) {
    if (treatmentStrategy === "ACCEPT" && sourceRequiresEscalation && topManagementApprovedBy === null) {
        throw new Error("risk_treatment_plans dengan treatment_strategy=ACCEPT pada risiko yang butuh eskalasi wajib topManagementApprovedBy terisi (BR-06).");
    }
}
//# sourceMappingURL=risk-treatment-rules.js.map