...
export const NOTIFICATION_DEAD_LETTER_QUEUE = "notification-dead-letter-queue";
...
export const NOTIFICATION_MAX_ATTEMPTS = process.env.NOTIFICATION_MAX_ATTEMPTS
  ? parseInt(process.env.NOTIFICATION_MAX_ATTEMPTS, 10)
  : 5;

export const NOTIFICATION_BACKOFF_BASE_DELAY_MS = 1000;
...
// TDD §26.
export const DEFAULT_NOTIFICATION_LANGUAGE = "ID" as const;
