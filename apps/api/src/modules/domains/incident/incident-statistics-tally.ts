...
// Pure logic — dipisah dari IncidentStatisticsCacheService supaya
// ter-unit-test tanpa DB (pola sama seluruh pure fn modul ini).
...
const COUNT_FIELD_BY_CLASSIFICATION: Record<IncidentClassification, keyof IncidentTallyResult | null> = {
...
export function tallyIncidentCounts(reports: IncidentTallyInput[]): IncidentTallyResult {
  const result: IncidentTallyResult = {
    fatalityCount: 0,
    ltiCount: 0,
