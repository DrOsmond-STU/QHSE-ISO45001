...
exports.DEFAULT_MEDICAL_RECORD_MINIMUM_RETENTION_DAYS = void 0;
exports.canProcessErasureRequest = canProcessErasureRequest;
...
exports.DEFAULT_MEDICAL_RECORD_MINIMUM_RETENTION_DAYS = 5 * 365;
function canProcessErasureRequest(input) {
    const minimumRetentionDays = input.minimumRetentionDays ?? exports.DEFAULT_MEDICAL_RECORD_MINIMUM_RETENTION_DAYS;
    const daysSinceLastActivity = Math.floor((input.requestDate.getTime() - input.lastRecordActivityDate.getTime()) / (1000 * 60 * 60 * 24));
...
//# sourceMappingURL=consent-and-subject-request-rules.js.map