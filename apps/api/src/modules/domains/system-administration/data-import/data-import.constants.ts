...
// jadi penghubungnya.
export const DATA_IMPORT_ENTITY_TYPE = "DATA_IMPORT_JOB";

export const DATA_IMPORT_ALLOWED_MIME_TYPES = [
...
export const DATA_IMPORT_VALIDATE_JOB_NAME = "validate";
export const DATA_IMPORT_COMMIT_JOB_NAME = "commit";
export const DATA_IMPORT_VALIDATE_MAX_ATTEMPTS = 10;
export const DATA_IMPORT_COMMIT_MAX_ATTEMPTS = 3;
...
export const DATA_IMPORT_BATCH_SIZE = 500;
