...
GRANT SELECT, INSERT, UPDATE, DELETE ON "document_categories" TO qhse_app;

ALTER TABLE "documents" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "documents" FORCE ROW LEVEL SECURITY;
CREATE POLICY tenant_isolation_policy ON "documents"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "documents" TO qhse_app;

ALTER TABLE "document_versions" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "document_versions" FORCE ROW LEVEL SECURITY;
CREATE POLICY tenant_isolation_policy ON "document_versions"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "document_versions" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "document_distribution"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "document_distribution" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "read_acknowledgement_logs"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "read_acknowledgement_logs" TO qhse_app;
...
CREATE POLICY tenant_isolation_policy ON "document_review_schedule"
  USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
GRANT SELECT, INSERT, UPDATE, DELETE ON "document_review_schedule" TO qhse_app;
