...
export const DOCUMENT_REVIEW_SCAN_QUEUE = "document-review-scan";
export const DOCUMENT_REVIEW_SCAN_JOB_NAME = "scan";
export const DOCUMENT_REVIEW_SCAN_CRON = process.env.DOCUMENT_REVIEW_SCAN_CRON ?? "15 1 * * *";
