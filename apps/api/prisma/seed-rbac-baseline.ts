...
export const SUPER_ADMIN_PLATFORM_ROLE_CODE = "SUPER_ADMIN_PLATFORM";
// Modul 02 §3 — baris Super Admin Platform: "user_mgmt.permission.manage (katalog global)".
export const PERMISSION_MANAGE_CODE = "user_mgmt.permission.manage";

export const ROLE_CODES = {
  SUPER_ADMIN_PLATFORM: SUPER_ADMIN_PLATFORM_ROLE_CODE,
...
const SYSTEM_ROLES: RoleSeed[] = [
  { roleCode: ROLE_CODES.SUPER_ADMIN_PLATFORM, name: "Super Admin Platform", description: "Lintas seluruh tenant — provisioning tenant & katalog permission global." },
  { roleCode: ROLE_CODES.TENANT_ADMIN, name: "Tenant Admin", description: "Administrasi penuh dalam satu tenant." },
  { roleCode: ROLE_CODES.COMPANY_ADMIN, name: "Company Admin", description: "Administrasi terbatas pada company scope-nya." },
  { roleCode: ROLE_CODES.HSE_MANAGER, name: "HSE Manager", description: "Manajerial HSE, scope site/branch." },
  { roleCode: ROLE_CODES.HSE_OFFICER, name: "HSE Officer", description: "Operasional HSE, scope site." },
  { roleCode: ROLE_CODES.DEPARTMENT_HEAD, name: "Department Head", description: "Kepala departemen, scope timnya." },
  { roleCode: ROLE_CODES.SUPERVISOR, name: "Supervisor", description: "Supervisor lini, scope timnya." },
  { roleCode: ROLE_CODES.AUDITOR_INTERNAL, name: "Auditor Internal", description: "Audit internal, read-only lintas scope yang ditugaskan." },
  { roleCode: ROLE_CODES.AUDITOR_EXTERNAL, name: "Auditor Eksternal (Read-only)", description: "Auditor tamu eksternal, read-only tanpa export credential sensitif." },
  { roleCode: ROLE_CODES.WORKER_EMPLOYEE, name: "Worker/Employee", description: "Karyawan operasional, self-service." },
  { roleCode: ROLE_CODES.CONTRACTOR_USER, name: "Contractor User", description: "Pekerja kontraktor, akses terbatas proyek/site." },
  { roleCode: ROLE_CODES.VISITOR_SELF_SERVICE, name: "Visitor (Self-service)", description: "Pengunjung, self-service terbatas." },
  { roleCode: ROLE_CODES.OCCUPATIONAL_HEALTH_STAFF, name: "Occupational Health Staff", description: "Akses medical record terisolasi (Master PRD §8.4)." },
  { roleCode: ROLE_CODES.DOCUMENT_CONTROLLER, name: "Document Controller", description: "Kelola siklus hidup dokumen terkontrol DMS (Modul 03 §3)." },
  { roleCode: ROLE_CODES.COMPLIANCE_OFFICER, name: "Compliance Officer", description: "Kelola register regulasi & izin/lisensi (Modul 04 §3)." },
  { roleCode: ROLE_CODES.QUALITY_MANAGER, name: "Quality Manager/QA Head", description: "Approval tertinggi modul mutu — disposisi NCR, komplain, deviasi inspeksi, evaluasi supplier, sasaran mutu (Modul 11 §3)." },
  { roleCode: ROLE_CODES.QC_INSPECTOR, name: "QC Inspector", description: "Pencatatan NCR & inspeksi mutu operasional (Modul 11 §3)." },
  { roleCode: ROLE_CODES.ENVIRONMENTAL_OFFICER, name: "Environmental Officer", description: "Kelola register aspek-dampak, pemantauan lingkungan, manifest limbah, self-assessment PROPER (Modul 12 §3)." },
  { roleCode: ROLE_CODES.TPS_LB3_OFFICER, name: "TPS LB3 Officer/Waste Handler", description: "Logbook neraca limbah harian & pencatatan manifest di TPS (Modul 12 §3)." },
];
...
function crudPermissions(moduleCode: string, entity: string, groupName: string, descPrefix: string): PermissionSeed[] {
...
const ORG_PERMISSIONS: PermissionSeed[] = [
...
const orgCodes = (entity: string, ...actions: readonly string[]) => actions.map((a) => `org.${entity}.${a.toLowerCase()}`);
const orgCrud = (entity: string) => orgCodes(entity, ...CRUD);
...
const USER_MGMT_PERMISSIONS: PermissionSeed[] = [
  { code: PERMISSION_MANAGE_CODE, moduleCode: "USER_MGMT", entity: "permission", action: "MANAGE", groupName: USER_MGMT_ADMIN_GROUP, description: "Kelola katalog permission global (Super Admin Platform)" },
...
const NOTIFICATION_PERMISSIONS: PermissionSeed[] = [
...
const DMS_PERMISSIONS: PermissionSeed[] = [
...
const COMPLIANCE_PERMISSIONS: PermissionSeed[] = [
...
const RISK_PERMISSIONS: PermissionSeed[] = [
...
const RISK_HIRA_JSA_HIRADC_PERMISSIONS: PermissionSeed[] = [
...
const WORK_PERMIT_PERMISSIONS: PermissionSeed[] = [
...
const INCIDENT_PERMISSIONS: PermissionSeed[] = [
...
const INSPECTION_PERMISSIONS: PermissionSeed[] = [
...
const EMERGENCY_RESPONSE_PERMISSIONS: PermissionSeed[] = [
...
const AUDIT_PERMISSIONS: PermissionSeed[] = [
...
const CAPA_PERMISSIONS: PermissionSeed[] = [
...
const QUALITY_PERMISSIONS: PermissionSeed[] = [
...
const ENVIRONMENTAL_PERMISSIONS: PermissionSeed[] = [
...
const OCCUPATIONAL_HEALTH_PERMISSIONS: PermissionSeed[] = [
...
const ASSET_EQUIPMENT_PERMISSIONS: PermissionSeed[] = [
...
const CALIBRATION_PERMISSIONS: PermissionSeed[] = [
...
const CONTRACTOR_PERMISSIONS: PermissionSeed[] = [
...
const ALL_PERMISSIONS: PermissionSeed[] = [
  ...ORG_PERMISSIONS,
...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  [ROLE_CODES.VISITOR_SELF_SERVICE]: [
    "emergency_response.muster_checkin.self_submit",
    "emergency_response.drill.view_own_participation",
  ],
  [ROLE_CODES.DOCUMENT_CONTROLLER]: [
    "dms.document.create",
    "dms.document.update",
    "dms.document.retire",
    "dms.version.create",
  ...
  [ROLE_CODES.OCCUPATIONAL_HEALTH_STAFF]: [
    "incident.report.update",
  ...
  // literal.
  [ROLE_CODES.ENVIRONMENTAL_OFFICER]: [
    "environmental.aspect_impact.create",
    "environmental.monitoring.create",
    "environmental.waste_manifest.manage",
    "environmental.proper_assessment.create",
  ...
  // match literal.
  [ROLE_CODES.TPS_LB3_OFFICER]: [
    "environmental.waste_generation_log.create",
    "environmental.waste_manifest.create",
  ],
};

function crudCodes(moduleCode: string, entity: string): string[] {
  return CRUD.map((a) => `${moduleCode}.${entity}.${a.toLowerCase()}`);
}

async function upsertPermissionGroups(prisma: Prisma.TransactionClient | PrismaClient): Promise<Map<string, string>> {
...
export async function seedRbacBaseline(prisma: PrismaClient): Promise<void> {
