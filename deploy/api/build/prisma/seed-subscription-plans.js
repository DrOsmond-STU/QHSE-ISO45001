...
exports.SUBSCRIPTION_PLAN_SEEDS = void 0;
...
exports.SUBSCRIPTION_PLAN_SEEDS = [
...
async function seedSubscriptionPlans(prisma) {
    for (const seed of exports.SUBSCRIPTION_PLAN_SEEDS) {
...
async function main() {
    ...
    console.log(`subscription_plans baseline siap: ${exports.SUBSCRIPTION_PLAN_SEEDS.map((s) => s.planName).join(", ")}.`);
