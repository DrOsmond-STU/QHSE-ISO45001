...
export const AUDIT_LOG_PARTITION_MAINTENANCE_QUEUE = "audit-log-partition-maintenance";
export const AUDIT_LOG_PARTITION_MAINTENANCE_JOB_NAME = "ensure-partitions";
...
export const AUDIT_LOG_PARTITION_MAINTENANCE_CRON =
  process.env.AUDIT_LOG_PARTITION_MAINTENANCE_CRON ?? "10 0 1 * *";
...
export const AUDIT_LOG_TABLE_NAME = "system_audit_logs";
export const AUDIT_LOG_TRIGGER_FUNCTION_NAME = "audit_log_capture";
