...
function requireActorUserId() {
    ...
    if (!userId) {
        throw new Error("Actor user_id tidak ditemukan di context — operasi occupational health ditolak (fail closed).");
    }
    return userId;
}
function requireTenantId() {
    ...
    if (!tenantId) {
        throw new Error("Tenant context tidak ditemukan — operasi occupational health ditolak (fail closed).");
    }
    return tenantId;
}
//# sourceMappingURL=occupational-health-context.js.map