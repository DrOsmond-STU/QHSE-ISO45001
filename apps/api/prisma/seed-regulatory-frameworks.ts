...
import { PrismaClient, RegulatoryFrameworkCategory } from "@prisma/client";
...
export async function seedRegulatoryFrameworks(prisma: PrismaClient): Promise<void> {
