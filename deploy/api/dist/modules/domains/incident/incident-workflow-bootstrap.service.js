...
exports.IncidentWorkflowBootstrapService = void 0;
...
const INCIDENT_INVESTIGATION_WORKFLOW_NAME = "Incident Investigation — 1/2 Level (Review Laporan Investigasi -> [kondisional] Persetujuan Pelaporan Regulator)";
...
let IncidentWorkflowBootstrapService = class IncidentWorkflowBootstrapService {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    async findRoleOrThrow(tx, roleCode) {
        ...
        if (!role) {
            throw new common_1.NotFoundException(`Role sistem "${roleCode}" tidak ditemukan — RBAC baseline (seed-rbac-baseline.ts) wajib dijalankan sebelum modul Incident bisa membuat workflow_definitions default.`);
        }
        return role;
    }
    /**
...
exports.IncidentWorkflowBootstrapService = IncidentWorkflowBootstrapService;
exports.IncidentWorkflowBootstrapService = IncidentWorkflowBootstrapService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], IncidentWorkflowBootstrapService);
//# sourceMappingURL=incident-workflow-bootstrap.service.js.map