...
export async function seedUserInTenant(
  tenantId: string,
  label = "Test User",
  overrides: { siteId?: string; userType?: UserType } = {},
): Promise<SeededUser> {
...
/** site_id pada emergency_response_plans/teams/drills/activations/checkins
 * PUNYA FK sungguhan — test yang perlu mengisi siteId wajib pakai baris
 * nyata, bukan randomUUID(). Pola PERSIS test/incident|inspection/test-helpers.ts. */
