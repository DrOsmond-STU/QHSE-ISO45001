...
exports.validateWorkPermitStatusTransition = validateWorkPermitStatusTransition;
...
function validateWorkPermitStatusTransition(from, to) {
    if (!ALLOWED_TRANSITIONS[from].includes(to)) {
        throw new Error(`Transisi work_permits.status dari ${from} ke ${to} tidak valid.`);
    }
}
//# sourceMappingURL=work-permit-lifecycle.js.map